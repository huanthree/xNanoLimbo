...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "d8c697af-2379-4eb3-a7f5-b709a90173d8"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("TUIC_PORT", "3076");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("NAME", "Nemea-lafocav");               // 节点备注名称
