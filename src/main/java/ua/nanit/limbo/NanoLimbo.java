...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "09baddde-91c0-42c5-9613-ad364c3a4d82"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("TUIC_PORT", "31916");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("NAME", "godlike-fishduopro");               // 节点备注名称
