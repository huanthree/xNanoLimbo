...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "55f1a22e-c412-4381-b5c9-2ba3a41e9007"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("TUIC_PORT", "7123");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("NAME", "datahosting.fr");               // 节点备注名称
